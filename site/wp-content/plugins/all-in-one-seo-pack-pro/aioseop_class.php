...
class All_in_One_SEO_Pack extends All_in_One_SEO_Pack_Module {
		   ...
		   "404_title_format"=> Array( 
			...
			$this->layout = Array(
				...
				'cpt' => Array(
						...
						'options' => Array( "enablecpost", "cpostadvanced", "cpostactive", "taxactive", "cposttitles" )
					),
				'display' => Array(
				...
				'noindex' => Array(
						...
						'options' => Array( 'cpostnoindex', 'cpostnofollow', 'cpostnoodp', 'cpostnoydir', 'category_noindex', 'archive_date_noindex', 'archive_author_noindex', 'tags_noindex', 'search_noindex', 'tax_noindex', 'paginated_noindex', 'paginated_nofollow', 'noodp', 'noydir' )
					),
				'advanced' => Array(
	...
	function add_admin_pointers() {
		$this->pointers['aioseop_menu_230'] = Array( 'pointer_target' => '#toplevel_page_all-in-one-seo-pack-pro-aioseop_class',
...
// Thank you, Yoast de Valk, for much of this code.	
	...
	function get_tax_title_format( $tax = '' ) {
		...
		else if ( !empty( $aioseop_options['aiosp_cpostadvanced'] ) ) {
