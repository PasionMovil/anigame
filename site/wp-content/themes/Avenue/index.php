<?php get_header(); ?>
<script src="http://px.smowtion.com/validate?sid=174965" type="text/javascript"></script>
            <!-- BEGIN MAIN -->
            <div id="main">
                    ...
                    <div id="wrapper-slides">
                        ...
                        <div id="slider" class="nivoSlider">
                            <?php while($featured_posts->have_posts()): $featured_posts->the_post(); ?>
                                ...
                                <?php else: ?>
                                    <a href='<?php the_permalink(); ?>' title='<?php the_title(); ?>'><img src="http://cdn.anigame.mx/wp-content/themes/anigame/images/thumbnail.png" alt="<?php the_title(); ?>" title="#htmlcaption_<?php the_ID(); ?>" rel="<?php bloginfo('template_directory'); ?>/timthumb.php?src=<?php bloginfo('template_directory'); ?>/images/thumbnail.png&w=70&h=60" width='516' height='340' /></a>
                                <?php endif; ?>
                            <?php endwhile; ?>
                        </div>
                ...
                <?php if(get_option('pyre_homepage_style') == 'magazine'): ?>
                    ...
                    <div class="block full">
                        ...
                        <div class="block-item-small">
                            ...
                            <?php else: ?>
                            <div class="block-image"><a href='<?php the_permalink(); ?>' title='<?php the_title(); ?>'><img src="http://cdn.anigame.mx/wp-content/themes/anigame/images/thumbnail.png" alt="<?php the_title(); ?>" width='50' height='50' /></a><?php echo $icon; ?></div>
                            <?php endif; ?>
                            <h2><a href='<?php the_permalink(); ?>' title='<?php the_title(); ?>'><?php the_title(); ?></a></h2>
                            <span class="block-meta"><?php the_time('F j, Y'); ?>, <?php comments_popup_link(); ?></span>
                        </div>
                    ...
                    <div class="block archive">
                        ...
                        <div id="post-<?php the_ID(); ?>" <?php post_class('block-item-big'); ?>>
                            ...
                            <div class="block-image"><a href='<?php the_permalink(); ?>' title='<?php the_title(); ?>'><img src="<?php echo $image[0]; ?>" alt="<?php the_title(); ?>" width='290' height='160' /></a><?php echo $icon; ?></div>
                            <?php else: ?>
                            <div class="block-image"><a href='<?php the_permalink(); ?>' title='<?php the_title(); ?>'><img src="http://cdn.anigame.mx/wp-content/themes/anigame/images/thumbnail.png" alt="<?php the_title(); ?>" width='290' height='160' /></a><?php echo $icon; ?></div>
                            <?php endif; ?>
                            <h2><a href='<?php the_permalink(); ?>' title='<?php the_title(); ?>'><?php the_title(); ?></a></h2>
