...
<?php if (is_single()) { ?>
<!-- Hotwords --> 
 <script src="http://ads35886.hotwords.com.mx/show.jsp?id=35886&cor=005F00"></script>
...
<?php } else { ?>
    ...
    <meta property="og:url" content="http://anigame.mx"/>
    <meta property="og:image" content="http://anigame.mx/wp-content/uploads/2012/04/logoanigamea24bril20121.png" />
<?php } ?>
...
<style type='text/css'>
body { background:#<?php echo get_option('pyre_bg_color'); ?> url('http://anigame.mx/wp-content/uploads/2012/05/Anigame_Wallpaper.jpg') repeat; }
